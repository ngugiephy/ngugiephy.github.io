$(window).on('load', function() {
  ...
  // alert("adsf");
  $('#op').html('<div class="animate__animated animate__bounce" style="color:#00FF49;background-color: #616161;box-shadow: 0px 0px 8px #888888;padding:5px;margin-bottom:10px;margin-top:0px;">Content Loaded <i class="fa fa-check"></i></div><button onclick="fadeoutSplash()" type="button" class="btn btn-success btn-lg" id="enter" style="box-shadow: 0px 0px 8px #888888;margin-bottom:10px;">Enter Scene</button>');
